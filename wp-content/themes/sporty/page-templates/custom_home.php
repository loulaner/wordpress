 ...
 <?php query_posts(array('post__in'=>get_option('sticky_posts'))); ?>
	<?php while (have_posts()) : the_post(); ?>
		<article class="sticky">
                ...
                <?php echo content(50); ?><div class="stickymore"><a href="<?php the_permalink() ?>"> More</a></div>
		</article>
	<?php endwhile; ?>
...
<?php $the_query = new WP_Query(array(
 ...
 ?>
    <?php while ($the_query -> have_posts()) : $the_query -> the_post(); ?>
      ...
      <li class="blog-lists-content"><?php echo get_excerpt(); ?><a href="<?php the_permalink() ?>"> More...</a></li>
      </ul>
      </div>
    <?php endwhile;?>
<!-- LOOP FINNISH -->
