...
function timeturner_display_footer_widgets() { 
    $theme_folder = get_template_directory_uri();
		...
		<?php _e('#wrapper #footer { padding: 35px 0 25px; } #wrapper .footer-signature { background: left top repeat-x url(', 'timeturner'); ?><?php echo $theme_folder ?><?php _e('/images/line-footer.png); }', 'timeturner'); ?>
<?php } 
}
...
function timeturner_background_color_and_image() {
    ...
    $background_attachment = get_theme_mod( 'background_attachment', get_theme_support( 'custom-background', 'background-attachment' ) );
		if ($background_color != '') { ?>
		<?php _e('#wrapper #wrapper-about, #wrapper #wrapper-blog, #wrapper #wrapper-content, #wrapper .about-box, #wrapper .about-box .about-radius { background-color: #', 'timeturner'); ?><?php echo $background_color ?><?php _e(';}', 'timeturner'); ?>
<?php } if ($background_image != '') { ?>
		<?php _e('#wrapper #wrapper-about, #wrapper #wrapper-blog, #wrapper #wrapper-content { background-image: url(', 'timeturner'); ?><?php echo $background_image ?><?php _e('); background-position: ', 'timeturner'); ?><?php echo $background_position ?><?php _e(' top; background-repeat: ', 'timeturner'); ?><?php echo $background_repeat ?><?php _e('; background-attachment: ', 'timeturner'); ?><?php echo $background_attachment ?><?php _e(';}', 'timeturner'); ?>
<?php } 
}
