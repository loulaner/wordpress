...
if(!class_exists('templ_latest_posts_with_images')){
	class templ_latest_posts_with_images extends WP_Widget {
		...
		//Constructor
		global $thumb_url;
			$widget_ops = array('classname' => 'widget special', 'description' => apply_filters('templ_latestpostwimg_widget_desc_filter','显示文章带图片和日期') );
			$this->WP_Widget('latest_posts_with_images',apply_filters('templ_latestpostwimg_widget_title_filter','T &rarr; 带图片和日期文章'), $widget_ops);
		}
