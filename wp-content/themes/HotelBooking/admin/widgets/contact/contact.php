...
class contact_widget extends WP_Widget {
	...
	//Constructor
		$widget_ops = array('classname' => 'Contact Us', 'description' => apply_filters('templ_contact_widget_desc_filter','使用此小工具在网站显示联系我们') );		
		$this->WP_Widget('widget_contact', apply_filters('templ_contact_widget_title_filter','T &rarr; 联系我们'), $widget_ops);
	}
