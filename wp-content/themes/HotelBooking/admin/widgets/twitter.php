...
if(!class_exists('templ_twitter'))
{
	class templ_twitter extends WP_Widget {
		...
		//Constructor
			$widget_ops = array('classname' => 'twitter', 'description' => apply_filters('templ_twitter_widget_desc_filter',__('显示twitter，www.4mudi.com四亩地提示：国外就不要用了，会拖慢速度.','templatic')) );
	...
	?>
        ...
        <p>
          <label for="<?php echo $this->get_field_id('show'); ?>"><?php  _e('No. of Tweets to display','templatic')?>:
        ...
        <p><?php _e('You should use this widget <b>once on the page</b>. As it will not display tweet for more than one ID.');?></p>
	<?php
		}
