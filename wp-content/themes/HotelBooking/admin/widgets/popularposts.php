...
if(!class_exists('templ_popularposts'))
{
	class templ_popularposts extends WP_Widget {
		...
		//Constructor
			$widget_ops = array('classname' => 'widget popularposts', 'description' => apply_filters('templ_popularpost_widget_desc_filter','使用此小工具显示热门文章到网站') );		
			$this->WP_Widget('templ_popularposts', apply_filters('templ_popularpost_widget_title_filter','T &rarr; 热门文章'), $widget_ops);
		}
