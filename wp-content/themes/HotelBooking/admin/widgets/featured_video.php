...
if(!class_exists('templ_featured_video')){
	class templ_featured_video extends WP_Widget {
		...
		//Constructor
			$widget_ops = array('classname' => 'widget featured_video', 'description' => apply_filters('templ_featuredvideo_widget_desc_filter','特定分类精选视频列表. 文章自定义字段 "video"必须用嵌入代码来显示.') );
			$this->WP_Widget('featured_video', apply_filters('templ_featuredvideo_widget_title_filter','T &rarr; 精选视频'), $widget_ops);
		}
