...
if(!class_exists('templ_flickr'))
{
	class templ_flickr extends WP_Widget {
		...
		//Constructor
			$widget_ops = array('classname' => 'widget flickr_photos ', 'description' => apply_filters('templ_flickr_widget_desc_filter','输入 Flickr ID来显示Flickr照片') );
			$this->WP_Widget('widget_flickrwidget', apply_filters('templ_flickr_widget_title_filter','T &rarr; Flickr照片'), $widget_ops);
		}
