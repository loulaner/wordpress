...
class subscribe extends WP_Widget {
	function subscribe() {
	//Constructor
		$widget_ops = array('classname' => 'widget Subscribe', 'description' => apply_filters('templ_subscribe_widget_desc_filter','Feedburner订阅电子邮件小工具') );		
		$this->WP_Widget('widget_subscribe', apply_filters('templ_subscribe_widget_title_filter','T &rarr; 订阅'), $widget_ops);
	}
