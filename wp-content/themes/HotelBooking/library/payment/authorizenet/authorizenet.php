  <table class="table" id="authorizenetoptions" style="display:none"   >
    ...
    <tr>
      ...
      <td class="row3"><select class="select" id="cc_type" name="cc_type" >
    ...
    <tr>
      ...
      <td class="row3"><select  class="select small_s" id="cc_month" name="cc_month">
        ...
        <select class="select small_s" id="cc_year" name="cc_year">
    ...
    <tr>
      ...
      <td class="row3"><input type="text" autocomplete="off" size="4" maxlength="5" id="cv2" name="cv2" class="textfield"/></td>
    </tr>
  </table>