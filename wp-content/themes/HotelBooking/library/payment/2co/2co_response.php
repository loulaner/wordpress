...
<input type="hidden" value="<?php echo $room_desc;?>" name="c_name"/>
<input type="hidden" value="<?php echo $room_desc;?>" name="c_description"/>
<input type="hidden" value="<?php echo $payable_amount;?>" name="c_price"/>
<input type="hidden" value="1" name="id_type"/>
<input type="hidden" value="<?php echo $last_bookingid;?>" name="cart_order_id"/>
...
<input type='hidden' name='x_invoice_num' value='<?php echo $last_bookingid;?>' />
