...
{
	$guidelink .= "theme-documentation/hotelbooking-theme-guide"; // templatic.com site theme guide url here
	return $guidelink;
}
...
{
	$forumlink .= "viewforum.php?f=74"; // templatic.com site Forum url here
	return $forumlink;
}
...
{
	return $content=__('Hotel Booking','templatic');
}
...
add_action('templ_page_title_below','templ_page_title_below_fun'); //page title above action hook
...
function templ_sidebar_widget_box_fun($content)
{
	...
	$position = array_keys($array_key,'footer1');
	$widget_pos = $position[0]+1;

$sidebar_widget_arr = array();
	$sidebar_widget_arr['index_page_content_left'] =array(1,array('name' => 'Home Page Content','id' => 'index_page_content_left','before_widget' => '','after_widget' => '','before_title' => '<h3>','after_title' => '</h3>'));
