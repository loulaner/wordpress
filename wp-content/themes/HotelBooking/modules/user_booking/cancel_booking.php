...
<div class="entry">
	<div <?php post_class('single clear'); ?> id="post_<?php the_ID(); ?>">
		<div class="post-content">
			<?php if(isset($_REQUEST['booking_id']) && $_REQUEST['booking_id'] != 0) {
				global $wpdb;
				...
				if(mysql_num_rows($check_booking_sql) > 0){
					...
					echo '<center><h4>Your Booking is Successfully Cancelled.</h4></center>';
				} else {
					echo '<center><h4>You have been already cancelled your Booking.</h4></center>';
				}
			} ?>
		</div>
	</div>
