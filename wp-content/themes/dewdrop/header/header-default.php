...
<head profile="http://gmpg.org/xfn/11">
	...
	<link rel="stylesheet" type="text/css" media="screen, print, handheld" href="<?php bloginfo('template_url') ?>/css/ie.css" />
	<![endif]-->
...
<body>
	...
	<div id="header">
		<div id="header-title">
		<!--<a href="<?php bloginfo('url'); ?>"><img src="<?php bloginfo('template_url'); ?>/img/title.png" alt="" /></a>-->
