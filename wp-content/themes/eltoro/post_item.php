...
<div class="cosmo-tabs submit" id="d39">
	...
	<div class="tabs-container" id="pic_upload">
			<?php CosmoUploader::print_form("附加图片","image",true,true, $first_column_class, $second_column_class );?>
	...
	<div class="tabs-container tabs-hide" id="video_upload">
		<?php CosmoUploader::print_form("附加视频","video",true,true, $first_column_class, $second_column_class)?>
	...
	<div class="tabs-container" id="audio_post">
			<?php CosmoUploader::print_form("附加音频","audio",false,false, $first_column_class, $second_column_class);
	...
	<div class="tabs-container" id="file_post">
		<?php CosmoUploader::print_form("附加文件","link",false,false, $first_column_class, $second_column_class);
