...
endhtml;
                ...
                case 'digit-like' : {
                    ...
                    $result .= '<input type="button" name="' . $name . '" value="' . __( '重置值' , 'cosmotheme' ) . '" class="generic-record-button  button-primary" ' . self::action( $action , 'digit-like' ) . ' /> <span class="digit-btn result"></span>';
                    break;
                }
