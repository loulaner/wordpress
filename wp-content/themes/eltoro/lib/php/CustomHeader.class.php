...
endhtml;
		...
		function render_signin_ul(){
			?>
                <ul class="sf-menu sf-js-enabled sf-shadow">
                    <li class="signin">
                        <a onclick="get_login_box(''); " href="javascript:void(0)"><?php _e( 'signin' , 'cosmotheme' );?><span><?php _e( 'members area' , 'cosmotheme' );?></span></a>
                    </li>
                </ul>
			<?php
		}
        ...
        function render_signin_anchor(){
            ?>
            <a onclick="get_login_box(''); " href="javascript:void(0)"><?php _e( 'signin' , 'cosmotheme' );?></a>
        <?php
        }
