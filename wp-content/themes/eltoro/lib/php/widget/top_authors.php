<?php
    class widget_top_authors extends WP_Widget {
        ...
        function widget_top_authors() {
            $widget_ops = array( 'classname' => 'widget_top_authors widget_tabber' , 'description' => __( '热门作者(使用此小工具需要安装WordPress JetPack插件)' , 'cosmotheme' ) );
            $this -> WP_Widget( 'widget_cosmo_top_authors' , _TN_ . ' : ' . __( '热门作者' , 'cosmotheme' ) , $widget_ops );
        }
