...
class widget_category_icons extends WP_Widget {
	...
	/*Constructor*/
		$widget_ops = array( 'classname' => 'widget_category_icons ', 'description' => __( '具有代表性图标的分类' , 'cosmotheme' ) );
		$this->WP_Widget( 'widget_cosmo_category_icons', _TN_ . ' : ' . __( '分类图标' , 'cosmotheme' ) , $widget_ops );
	}
