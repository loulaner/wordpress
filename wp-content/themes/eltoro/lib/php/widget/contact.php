<?php
    class widget_contact extends WP_Widget {
        function widget_contact() {
            $widget_ops = array( 'classname' => 'quick-contact _cosmo_contact', 'description' => __('显示联系表' , 'cosmotheme' ) );
            parent::WP_Widget( 'widget_cosmo_contact' , _TN_ . ' : ' . __( '快捷联系表' , 'cosmotheme' )  , $widget_ops );
