...
class widget_flickr extends WP_Widget {
	function widget_flickr() {
        ...
        /* Constructor */
		$widget_ops = array('classname' => 'widget_flickr_photos', 'description' => __( 'Flickr照片' , 'cosmotheme' ) );
		$this->WP_Widget('widget_cosmo_flickrwidget', _TN_ . ' : ' . __( 'Flickr照片' , 'cosmotheme' ), $widget_ops);
	}
