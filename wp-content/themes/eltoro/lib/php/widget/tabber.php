<?php
    class widget_tabber extends WP_Widget {
        ...
        function widget_tabber() {
            $widget_ops = array( 'classname' => 'widget_tabber ' , 'description' => __( '选项卡' , 'cosmotheme' ) );
            $this -> WP_Widget( 'widget_cosmo_tabber' , _TN_ . ' : ' . __( '选项卡' , 'cosmotheme' ) , $widget_ops );
        }
        ...
        ?>
            ...
            <ul class="widget_tabber">
                ...
                ?>
                        <li class="active"><a href="#tabber_hot_posts"><?php _e( '精选' , 'cosmotheme' )?></a></li>
                        <li><a href="#tabber_new_posts"><?php _e( '最新' , 'cosmotheme' )?></a></li>
                <?php
                    }else{
