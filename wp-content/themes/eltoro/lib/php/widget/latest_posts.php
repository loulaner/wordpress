...
class widget_latest_posts extends WP_Widget {
	...
	/*Constructor*/
		$widget_ops = array('classname' => 'widget_latest_posts ', 'description' => __( '最新文章' , 'cosmotheme' ) );
		$this->WP_Widget('widget_cosmo_latestPosts', _TN_ . ' : ' . __( '最新文章' , 'cosmotheme' ), $widget_ops);
	}
