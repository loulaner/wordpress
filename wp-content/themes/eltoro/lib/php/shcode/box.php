...
<div class="standard-generic-field generic-field-button">
    ...
    <div class="generic-field generic-field-button">
        <a href="javascript:void(0);" onclick="resetBoxSettings();" class="button">重置</a>
        <input type="button" onclick="insertBox()" id="insert_box_btn" value="插入信息框" class="button-primary">
    </div>
    <div class="clear"></div>
</div>