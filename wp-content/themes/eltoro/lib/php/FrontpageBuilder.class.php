<?php
	class FrontpageBuilder{
		...
		function __construct(){
            ...
            $this -> scriptdata[ 'translations' ][ 'showing' ] = __( '显示' , 'cosmotheme' );
            $this -> scriptdata[ 'translations' ][ 'widgets' ] = __( '小工具' , 'cosmotheme' );
            $this -> scriptdata[ 'translations' ][ 'page' ] = __( '页面' , 'cosmotheme' );
            $this -> scriptdata[ 'translations' ][ 'post' ] = __( '文章' , 'cosmotheme' );
            $this -> scriptdata[ 'translations' ][ 'posts' ] = __( '文章' , 'cosmotheme' );
            $this -> scriptdata[ 'translations' ][ 'from' ] = __( 'from' , 'cosmotheme' );
            $this -> scriptdata[ 'translations' ][ 'categories' ] = __( '分类' , 'cosmotheme' );
            $this -> scriptdata[ 'translations' ][ 'category' ] = __( 'category' , 'cosmotheme' );
            $this -> scriptdata[ 'translations' ][ 'please' ] = __( '什么都没有，请选择一些' , 'cosmotheme' );
            $this -> scriptdata[ 'translations' ][ 'in' ] = __( '在' , 'cosmotheme' );
            $this -> scriptdata[ 'translations' ][ 'with' ] = __( '的' , 'cosmotheme' );
            $this -> scriptdata[ 'translations' ][ 'carousel' ] = __( 'carousel' , 'cosmotheme' );
            $this -> scriptdata[ 'translations' ][ 'tag' ] = __( 'tag' , 'cosmotheme' );
            $this -> scriptdata[ 'translations' ][ 'tags' ] = __( '标签' , 'cosmotheme' );
            ...
            $this -> scriptdata[ 'translations' ][ 'gallery' ] = __( '图库' , 'cosmotheme' );
            ...
            $this -> scriptdata[ 'translations' ][ 'featured' ] = __( '个精选' , 'cosmotheme' );
            $this -> scriptdata[ 'translations' ][ 'latest' ] = __( '最新' , 'cosmotheme' );
