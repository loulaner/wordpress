<?php
    ...
    $res[ 'slideshow' ][ 'labels' ] = array(
        ...
        'add_new' => _x('添加', __('Slideshow','cosmotheme')),
    ...
    $res['testimonial']['labels'] = array(
        ...
        'add_new' => _x('添加', __('Testimonial','cosmotheme')),
...
//         $form['post']['format']['link']        = array( 'type' => 'st--upload-id' , 'label' => __( 'Please add attachment file or URL'  , 'cosmotheme' )  , 'classes' => 'post_format_link hidden' , 'id' => 'format_link' , 'hint' => __( 'Please use only .ZIP, .RAR, .DOC, .DOCX, .PDF files' , 'cosmotheme' ) );
    ...
    $form['page']['settings']['meta']       = array( 'type' => 'st--logic-radio' , 'label' => __( 'Show page meta' , 'cosmotheme' ) , 'hint' => '显示此页面文章meta' , 'cvalue' => 'no' );
    $form['page']['settings']['sharing']    = array( 'type' => 'st--logic-radio' , 'label' => __( 'Show social sharing' , 'cosmotheme' ) , 'hint' => '在此页面显示社交分享' , 'cvalue' => options::get_value( 'blog_post' , 'page_sharing' ) );
    $form['page']['settings']['author']     = array( 'type' => 'st--logic-radio' , 'label' => __( 'Show author box' , 'cosmotheme' ) , 'hint' => '在此页面显示作者框' , 'cvalue' => options::get_value( 'blog_post' , 'page_author_box' ) );
